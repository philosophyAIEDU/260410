    ...
    <div className="w-full">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-4 mb-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-green-50 border border-green-100 flex items-center justify-center flex-shrink-0">
              <svg className="w-4.5 h-4.5 text-green-600" style={{ width: '18px', height: '18px' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <div>
              <p className="text-sm font-bold text-slate-900">제안서 생성 완료</p>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button onClick={onReset} className="btn-secondary py-2 px-3.5">
              새 제안서
            </button>
            <button
              onClick={handleCopy}
              className="btn-secondary py-2 px-3.5 flex items-center gap-1.5"
            >
              {copied ? (
                <>
            ...
            <button
              ...
              className="btn-secondary py-2 px-3.5 flex items-center gap-1.5 disabled:opacity-50"
            >
              {docxLoading ? (
                <>
            ...
            <button
              ...
              className="btn-primary py-2 px-3.5 flex items-center gap-1.5"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex items-start gap-2 mt-4 pt-4 border-t border-slate-100 text-xs text-slate-500">
          <svg className="w-3.5 h-3.5 flex-shrink-0 mt-0.5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>
            <strong className="text-slate-600">Word 저장</strong>으로 .docx 파일을 받거나,
            <strong className="text-slate-600"> HTML 저장</strong>으로 원본을 저장할 수 있습니다.
            PDF로 저장하려면 <strong className="text-slate-600">인쇄 / PDF</strong>에서 "PDF로 저장"을 선택하세요.
          </span>
        </div>
      </div>
      ...
      <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
        <div className="flex items-center gap-2 px-4 py-2.5 bg-slate-50 border-b border-slate-200">
          ...
          <span className="text-xs text-slate-400 ml-2 font-mono tracking-tight">미리보기</span>
        </div>
        <iframe
          ref={iframeRef}
          srcDoc={html}

    ...
    <div className="max-w-lg mx-auto">
      <div className="card">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-slate-800">Google AI API 키</h2>
            <p className="text-sm text-slate-500">Gemini API 키를 입력해 주세요</p>
          </div>
        </div>
        ...
        <div className="mt-5 p-4 bg-slate-50 rounded-xl">
          <p className="text-xs text-slate-500 leading-relaxed">
            <span className="font-medium text-slate-600">API 키 발급 방법:</span>{' '}
            <a
